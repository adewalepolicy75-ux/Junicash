...
function Home() {
  const features = [
    { icon: <FiShield size={28} />, title: 'Top Security', desc: 'Your money and data are protected with bank-grade security. We take your safety seriously.', img: 'images/top-security1.png' },
    { icon: <FiTrendingUp size={28} />, title: 'Zero Interest Loans', desc: 'Borrow money when you need it most with absolutely no interest. We are here to support you.', img: 'images/zero-interest.png' },
      ...
      <section style={{ background: '#0a0a0f', padding: '5rem 2rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '3rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: '280px', display: 'flex', justifyContent: 'center' }}>
            <img src='/images/our logo.png' alt='JuniCash Banking' className='hero-img' style={{ width: '100%', maxWidth: '480px', borderRadius: '150px', objectFit: 'cover' }} />
          </div>
        </div>
      </section>
