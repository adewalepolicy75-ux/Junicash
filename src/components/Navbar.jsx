...
import { FiHome, FiSend, FiCreditCard, FiPieChart, FiLogOut, FiMenu, FiX, FiUser } from 'react-icons/fi'
...
function Navbar({ user, onLogout, activeTab, setActiveTab }) {
  ...
  const navItems = [
    ...
    { icon: <FiCreditCard size={16} />, label: 'Pay', tab: 'pay' },
    { icon: <FiPieChart size={16} />, label: 'Summary', tab: 'budget' },
    { icon: <FiCreditCard size={16} />, label: 'Card', tab: 'card' },
  ]
